...
export default function Home() {
    useEffect(() => {
        ...
        document.body.className = "bg-gray-900 text-gray-100 font-[Inter] theme-transition"
    ...
    return (
        <>
            ...
            {/* Tailwind CDN for your original styles */}
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                                ...
                                <a
                                    href="#"
                                    onClick={() => (window as any).showFavorites?.()}
                                ...
                                <a
                                    href="#"
                                    onClick={() => (window as any).showDoneList?.()}
                                    className="border-transparent text-gray-300 hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                                >
                                ...
                                <a
                                    href="#"
                                    onClick={() => (window as any).showFlashcards?.()}
                                    className="border-transparent text-gray-300 hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                                >
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="relative">
                                ...
                                <div
                                    id="importExportMenu"
                                    className="hidden absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-gray-700 ring-1 ring-black ring-opacity-5"
                                >
                                    <div className="py-1">
                                        <a
                                            href="#"
                                            onClick={() => (window as any).exportWords?.()}
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div className="p-6">
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-700">
                                    <thead>
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">done</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Word</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Translation</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Category</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Language Pair</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody id="wordsTableBody" className="divide-y divide-gray-700"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 mb-6 animate__animated animate__fadeIn">
                        ...
                        <div className="flex flex-wrap gap-4 mb-6">
                            <button onClick={() => (window as any).showGame?.("wordMatch")} className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">
                                Word Match
                            </button>
                            <button onClick={() => (window as any).showGame?.("speedChallenge")} className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition">
                                Speed Challenge
                            </button>
                            <button onClick={() => (window as any).showGame?.("memoryGame")} className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition">
                                Memory Cards
                            </button>
                            <button onClick={() => (window as any).showGame?.("dailyChallenge")} className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition">
                                Daily Challenge
                            </button>
                            <button onClick={() => (window as any).showGame?.("wordQuizChallenge")} className="px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition">
                                Word Quiz
                            </button>
                            <button onClick={() => (window as any).showGame?.("askTranslateChallenge")} className="px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition">
                                Ask Translate
                            </button>
                            <button onClick={() => (window as any).showGame?.("efmQuestions")} className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition">
                                EFM Questions
                            </button>
                        </div>
                        ...
                        <div id="gameContainers">
                            ...
                            <div id="wordMatch" className="game-container hidden">
                                ...
                                <div id="wordMatchContainer" className="grid grid-cols-2 gap-4" style={{ color: "black" }}></div>
                                <div className="mt-4">
                            ...
                            <div id="memoryGame" className="game-container hidden">
                                ...
                                <div id="memoryContainer" className="grid grid-cols-4 gap-4" style={{ color: "black" }}></div>
                                <div className="mt-4">
                            ...
                            <div id="dailyChallenge" className="game-container hidden">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow" style={{ color: "black" }}>
                                    ...
                                    <div id="dailyChallengeList" className="space-y-4" style={{ color: "black" }}></div>
                        ...
                        <div id="gameResultsModal" className="fixed inset-0 bg-black bg-opacity-50 hidden">
                            <div className="bg-white p-6 rounded-lg w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                ...
                                <button onClick={() => (window as any).closeGameResults?.()} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
                                    Close
                                </button>
                            </div>
                        </div>
            ...
            <button
                ...
                className="floating-action-button bg-indigo-500 hover:bg-indigo-500 text-white rounded-full p-0 shadow-lg"
                id="btnAddNewData"
            >
            ...
            <button
                ...
                className="floating-action-button bg-indigo-600 hover:bg-indigo-700 text-white rounded-full p-4 shadow-lg"
            >
            ...
            <div id="addWordModal" className="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full animate__animated animate__fadeIn">
                <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800 animate__animated animate__slideInUp">
                    <div className="mt-3">
                        ...
                        <form id="addWordForm" className="mt-4" onSubmit={(e) => { e.preventDefault(); (window as any).submitForm?.(e.nativeEvent); }}>
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        type="button"
                                        onClick={(e) => (window as any).speakWord?.(e.currentTarget)}
                            ...
                            <div className="flex justify-end mt-6">
                                <button
                                    type="button"
                                    onClick={() => (window as any).hideAddModal?.()}
                                    className="mr-3 px-4 py-2 bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600 focus:outline-none"
                                >
                                    Cancel
                                </button>
                                <button
                ...
                <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800">
                    <div className="mt-3">
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            <button onClick={() => (window as any).nextCard?.()} className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                                Next<i className="fas fa-arrow-right ml-2"></i>
                            </button>
                        </div>
                        <div className="flex justify-end mt-4">
                            <button onClick={() => (window as any).hideFlashcardModal?.()} className="text-gray-400 hover:text-white">
                                Close
                            </button>
                        </div>
                    </div>
            ...
            <div id="dailyChallengeModal" className="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full">
                <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800">
                    <div className="mt-3">
                        ...
                        <div className="flex justify-between mt-6">
                            <button onClick={() => (window as any).markLearned?.()} className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                                <i className="fas fa-check mr-2"></i>Mark as Learned
                            </button>
                            <button onClick={() => (window as any).hideDailyChallengeModal?.()} className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                                Later
                            </button>
                        </div>
                    </div>
