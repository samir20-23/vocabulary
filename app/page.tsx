    ...
    return (
        <div className="main">
                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            <button id="themeToggle"
                                ...
                                <i id="themeIcon" className="fas fa-moon" style="color:#CBD5E1; font-size:1.25rem;"></i>
                            </button>


                            <div className="relative">
                                <button onclick="toggleImportExportMenu()" className="p-2 rounded-full hover:bg-gray-700">
                                ...
                                <div id="importExportMenu"
                                    ...
                                    <div className="py-1">
                                        ...
                                        <label className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-600 cursor-pointer">
                                            ...
                                            <input type="file" className="hidden" accept=".json,.csv" onchange="importWords(event)">
                                        </label>
                                    </div>
                                </div>
                            </div>

                            <button onclick="showDailyChallenge()" className="p-2 rounded-full hover:bg-gray-700">
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 relative">
                        <input type="text" id="searchInput" placeholder="Search words..."
                            ...
                            <button onclick="startVoiceRecognition()" className="absolute right-3 top-2 text-gray-400 hover:text-white">
                                <i className="fas fa-microphone"></i>
                            </button>
                    </div>

                    <div id="tablemain"
                        className="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6 animate__animated animate__fadeIn">
                        <div id="tablemain" className="p-6">
                            <div id="tablemain" className="overflow-x-auto">
                                <table id="tablemain" className="min-w-full divide-y divide-gray-700">
                                    <thead>
                                        <tr>
                                            <th
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 mb-6 animate__animated animate__fadeIn">
                        ...
                        <div id="gameContainers">
                            ...
                            <div id="speedChallenge" className="game-container hidden">
                                ...
                                <div className="text-center">
                                    ...
                                    <input type="text" id="challengeInput" className="w-64 p-2 border rounded"
                                ...
                                <div className="bg-white p-6 rounded-lg shadow" style="color: black;">
                                    ...
                                    <div className="mt-4" style="color: black;">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                                            <div id="challengeProgressBar" className="bg-yellow-500 h-2.5 rounded-full"
                                                style="width: 0%"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="wordQuizChallenge" className="game-container hidden">
                                <!-- Populated via JS -->
                            </div>

                            <!-- New: Ask Translate Challenge -->
                            <div id="askTranslateChallenge" className="game-container hidden">
                                <!-- Populated via JS -->
                            </div>

                            <!-- New: EFM Questions Challenge -->
                            <div id="efmQuestions" className="game-container hidden">
                                <!-- Populated via JS -->
                            </div>
                        </div>
                        ...
                        <div id="gameResultsModal" className="fixed inset-0 bg-black bg-opacity-50 hidden">
                            <div
                                className="bg-white p-6 rounded-lg w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <button onclick="newWord()"
                ...
                id="btnAddNewData">
                <i className="fa-solid fa-paper-plane"></i> <!-- Icon for the first button -->
            </button>
            ...
            <div id="addWordModal"
                className="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full animate__animated animate__fadeIn">
                <div
                    className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800 animate__animated animate__slideInUp">
                    <div className="mt-3">
                        <h3 className="text-lg leading-6 font-medium text-gray-100">Add New Word</h3>
                        <form id="addWordForm" className="mt-4" onsubmit="submitForm(event)">
                            <div className="mb-4">
                            ...
                            <div className="mb-4">
                                ...
                                <textarea name="example" rows="2"
                                    className="mt-1 block w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                            </div>
            ...
            <div id="flashcardModal" className="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full">
                <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800">
                    <div className="mt-3">
                        ...
                        <div id="flashcard"
                            className="bg-gray-700 p-6 rounded-lg text-center cursor-pointer min-h-[200px] flex items-center justify-center">
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            <button onclick="nextCard()" className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                                Next<i className="fas fa-arrow-right ml-2"></i>
                            </button>
                        </div>
                        <div className="flex justify-end mt-4">
                            <button onclick="hideFlashcardModal()" className="text-gray-400 hover:text-white">
                                Close
                            </button>
                        </div>
                    </div>
            ...
            <div id="notification"
                className="hidden fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg animate__animated animate__fadeInUp">
            </div>
        </div>
    );
}
